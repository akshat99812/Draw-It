...
export const Canvas=()=>{
    ...
    return <div>
        <div className="flex justify-center ">
            ...
            <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" onClick={clear}>Clear</button>  
            </div>
            ...
            setEraserOn(true);
            }}>{eraserOn?"Draw":"Erase"}</button>  
            </div>

        </div>
        
        <div className="flex justify-center">
            <canvas ref={canvasRef} className=" border border black" width={700} height={700} onMouseDown={onMouseDown}></canvas>
        </div>
    </div>
}